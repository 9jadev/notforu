...
public $dbuser,$dbpassword, $dbhost, $dbname, $conn, $query,$query1,$fn,$ln,$em,$un,$ph,$pass,$cpass,$bio,$img_path,$img_ext,$img_dir,$img_name,$img_tmpname,$client,$message,$process,$process1,$row,$to,$id,$vid,$pn,$purl,$sid,$token,$rpp,$nor,$nop,$page,$tpfr,$subject,$headers;
   ...
   function register(){
    if (isset($_POST["process"])) {
        ...
        $this->query1 = " SELECT * FROM `customer` WHERE `customer_un` = '$this->un' || `customer_email` = '$this->em' || `customer_phone` = '$this->ph' || `customer_pass` = SHA('$this->pass') ";

        $this->process1 = mysqli_query($this->conn , $this->query1);
       if (mysqli_num_rows($this->process1) > 1) {
    echo ' <div class="alert alert-danger">   
      Unsername , email , phone may already be used buy another user
         </div>';
     exit();    
  }

    $this->query="INSERT INTO `customer` (`customer_un`, `customer_fn`, `customer_ln`, `customer_img`, `customer_num`, `customer_email`, `customer_phone`, `customer_pass`, `customer_date`) VALUES ('$this->un','$this->fn','$this->ln', '2.png','$this->bio','$this->em','$this->ph',sha1('$this->pass'),NOW())";
...
<p><span style="font-family:Comic Sans MS, cursive"><strong>&nbsp; &nbsp; &nbsp;You are welcome to Spring Heritage Bank we hope to server you in the best way possible.
    your account has been created and is currently under verification it will be activated shortly thank you.
</strong></span></p>
...
<div style="text-align:center">
	...
	<tbody>
		...
		<tr>
			<td>&nbsp; &nbsp;<strong>ACOUNT NAME</strong></td>
			<td>&nbsp; &nbsp;&nbsp;<strong>'.$this->fn.' '.$this->ln.'</strong></td>
		</tr>
		<tr>
			<td>&nbsp; &nbsp;<strong>ACOUNT PASSWORD</strong></td>
			<td>&nbsp; &nbsp; &nbsp;<strong>'.$this->pass.'</strong></td>
		</tr>
	</tbody>
</table>
</div>

<p> This is an automated Confirmation Alert Service . You are getting this email because a you  just created an account with spring heritage bank .</p>
...
mail($this->to,$this->subject,$this->message,$this->headers);
     ...
     // header('location:user');
      echo '
      <br><br>
      <div class="alert alert-danger">Congratulations dear '.$this->fn.' '.$this->ln.',<br>
        your account creation process will be verified by our team of customer relations offices this process usually takes 24 hours of a working day after you will be informed .</div>';
    }else{
      echo "data base errors";
    }
    }
   } 
  ...
  function ulogin(){
      if (isset($_POST['ulogin'])) {
        ...
        $this->query = "SELECT * FROM `customer` WHERE `customer_un`= '$this->un' AND `customer_pass` = SHA1('$this->pass')";
        $this->process = mysqli_query($this->conn , $this->query);
   ...
   function genbal3(){
    ...
    if (mysqli_num_rows($this->process) == 1) {
      ...
      if ($this->process1) {
          ...
          <p>Congratulations '.$this->fn.' your account has been full activate.<br> Welome to spring heritage  bank </p>
  ...
  function pro(){
    ...
    echo '<div class="dashboard-stat color-1">
          <div class="dashboard-stat-content"><h4>'.$this->fn.'</h4> <span>Acount balance</span><br>
            <small>id : '.$this->id.'</small></div>
...
<p><span style="text-align: center;"  ><strong>&nbsp; &nbsp; &nbsp; SPRING HERITAGE BANK CREDIT ALERT 
...
<p><span style="text-align: center;"  ><strong>&nbsp; &nbsp; &nbsp; SPRING HERITAGE BANK DEBIT ALERT 
...
<p><span><strong>&nbsp; &nbsp; &nbsp; SPRING HERITAGE BANK Credit Alert  as a result of transfer transaction
...
mail($this->to,$this->subject,$this->message,$this->headers);
   ...
   function mess(){
    ...
    $this->process = mysqli_query($this->conn , $this->query);
    if (mysqli_num_rows($this->process) == 0 ) {
      $this->query1 = " INSERT INTO `messages` (`messs_to`, `mess_from`, `view`, `mess_cont`, `mess_date`) VALUES ('$this->id', 'Customer Service', 'no', 'Hello dear,<br> Customer you are welcome to Spring Heritage Bank for any complains contact us with our customer service chat platform .', NOW()) ";
    $this->process1 = mysqli_query($this->conn , $this->query1);
...
$this->message = '   Dear customer you requested for a password reset please follow this link to reset your password https://springheritage-bank.com/change_password.php?reset='.$this->row["customer_num"];
...
<html>
  <head>
    <title> Spring Premium Account confirmation </title>
  </head>
  <body style="padding: 10px;  ">
  <p>&nbsp; &nbsp;&nbsp;</p>
...
<p><span style="font-family:Comic Sans MS, cursive"><strong>&nbsp; &nbsp; &nbsp; You are welcome to Spring Heritage premium Banking </strong></span></p>
...
<h3 style="margin-top: 0px; margin-bottom: 32px; color: #11a7e3;"> Spring heritage Premium Banking acount </h3>
...
<html>
  <head>
    <title> Spring  Account frozen </title>
  </head>
  <body style="padding: 10px;  ">
  <p>&nbsp; &nbsp;&nbsp;</p>
...
<p> This is an automated Confirmation Alert Service .you are recieving this message  because your bank account is under investigation and has been frozen. please contact customer service for more infomation as soon as possible.</p>
...
<p><span style="font-family:Comic Sans MS, cursive"><strong>&nbsp; &nbsp; &nbsp;You are welcome once again  to Spring Heritage Bank we wish to inform you that your account has been recieved and activated  by our team of customer service executives we hope to server you in the best way possible .</strong></span></p>
...
mail($this->to,$this->subject,$this->message,$this->headers);
    ...
    function gettransact(){
      ...
      <div class=" panel col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center" style="border: 1px solid; border-radius: 3px;">
          ...
          <p style="margin-bottom: 0px;">Bank: '.($row["bank"] == 'same' ? 'SPRING HERITAGE BANK' : $row["bank"]).'</p>
...
If this is a forwarded message, the content of this E-MAIL may not have been sent with the authority of the Bank. Spring Heritage Bank shall not be liable for any mails sent without due authorisation or through unauthorised access.
If you are not the intended recipient, an agent of the intended recipient or a person responsible for delivering the information to the named recipient, you are notified that any use, distribution, transmission, printing, copying or dissemination of this information in any way or in any manner is strictly prohibited.
If you have received this communication in error, please delete this mail and notify us immediately at info@springheritage=bank.com.
  </body> 
